...
public class RestauranteController {
	...
	public ResponseEntity<List<Restaurante>> buscaRTTPorNomeFrete(@RequestParam String nome,
			@RequestParam BigDecimal taxaFreteInicia,@RequestParam BigDecimal taxaFreteFinal) {
